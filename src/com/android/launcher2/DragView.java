...
public class DragView extends View {
	 ...
	 * <p>
	 * 
	 * 注册点，当对着程序图标长按下之后，dragview出来的时候，触摸到的点就是注册点。 如果DragView和原始view一样大则注册点为0。
	 * 
	 * @param launcher
	...
	public DragView(Launcher launcher, Bitmap bitmap, int registrationX,
		...
		// 将DragView根据registration point移动到正确的位置
		...
		// the layout pass
		// 强制measure,因为在构建完成前Workspace就调用了getMeasuredHeight()
	...
	/**
	 * 移动包含此view的window？不就是移动这个view么？？touchX，touchY是手指触摸点相对于DragLayer的位置。
	 * 
	 * @param touchX
	 *            the x coordinate the user touched in DragLayer coordinates
	 * @param touchY
